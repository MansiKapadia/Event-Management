<%@ Page Title="" Language="VB" MasterPageFile="~/User/MasterPageOfUserProfile.master" AutoEventWireup="false" CodeFile="Dashboard.aspx.vb" Inherits="User_Default2" %>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-10 col-md-9 col-sm-12 col-12">
                        <div class="dashboard-page-header">
                            ...
                            <h3 class="dashboard-page-title">Hi, User.</h3>
                            <p class="d-block">Here’s what’s happening with your Profile.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card card-summary">
                            <div class="card-body">
                              ...
                              <div class="card-footer text-center"><a href="Home.aspx">View All</a></div>
