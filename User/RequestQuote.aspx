<%@ Page Title="" Language="VB" MasterPageFile="~/User/MasterPageOfUserProfile.master" AutoEventWireup="false" CodeFile="~/Vendor/RequestQuote.aspx.vb" Inherits="Vendor_Default2" %>
                        ...
                        <div class="card request-list-table table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT * FROM [Request_Quote] WHERE ([Uid] = @Uid)">
                                        <SelectParameters>
